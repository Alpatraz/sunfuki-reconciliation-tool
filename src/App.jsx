...
function findShopifySize(row,rawProduct,productKey){
  ...
  // Source principale : le titre Shopify complet.
  const fromTitle=extractSize(rawProduct);
  if(fromTitle)return fromTitle;

  // Sécurité : propriétés de ligne Shopify contenant "Taille : ..."
  ...
  // Fallback : éventuelle colonne taille explicite.
  const direct=extractSize(pick(row,["Taille","Size","Variant","Option","Correction taille"]));
