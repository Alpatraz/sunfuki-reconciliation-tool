...
async function validateCommentRow(item){
  ...
  setCommentCorrectionStatus("Sauvegarde validation commentaire...");
  try{
    const payload={
    ...
    setCommentCorrectionStatus("Commentaire traité / validé");
  }catch(e){
...
const commentSizeReviewRows=useMemo(()=>{
  return (reconciled||[])
    ...
    .map(r=>({Commande:r.order,Compétiteur:r.competitor,Email:r.email||"",Dojo:r.dojo||"",Équipe:displayTeamCategory(r.team)||r.team||"",Produit:r.product,"Produit Shopify brut":r.rawProduct||"","Taille Shopify":r.shopifySize||"","Taille Supabase":r.supabaseSize||"","Taille finale":r.finalSize||"","Source taille":r.sourceSize||"",Commentaire:r.comments||"","Commentaire traité":"Non","Statut taille":sizeValidationStatus(r),productKey:r.productKey,raw:r}));
...
return <div className="app"><header><h1>Réconciliation Sunfuki V33.21</h1><p>Sources colorées · alertes compétiteurs · engagements manquants · exports filtrés par club.</p></header><section className="sourceStatusGrid">
