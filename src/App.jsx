...
return <div className="app"><header><h1>Réconciliation Sunfuki V27</h1><p>Sources colorées · alertes compétiteurs · engagements manquants · exports filtrés par club.</p></header><section className="sourceStatusGrid">
